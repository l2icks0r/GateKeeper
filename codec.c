...
void codec_ctrl_init()
{
	...
	//CodecCommandBuffer[1] = 0x03; // mute A & B
	...
	CodecCommandBuffer[1] = 0x10; // less headphone gain
	send_codec_ctrl(CodecCommandBuffer, 2);

	CodecCommandBuffer[0] = CODEC_MAP_CLK_CTRL;
	//CodecCommandBuffer[1] = 0x81; //auto detect clock
	//CodecCommandBuffer[1] = 0x80; // auto detect clock, no div2
	CodecCommandBuffer[1] = 0x20;
	send_codec_ctrl(CodecCommandBuffer, 2);

	CodecCommandBuffer[0] = CODEC_MAP_IF_CTRL1;
	CodecCommandBuffer[1] = 0x07; // I2S 16 bit
	send_codec_ctrl(CodecCommandBuffer, 2);
	...
	CodecCommandBuffer[0] = CODEC_MAP_PCMA_VOL | CODEC_MAPBYTE_INC;
	CodecCommandBuffer[1] = 0x00;
	CodecCommandBuffer[2] = 0x00;
	send_codec_ctrl(CodecCommandBuffer, 3);

	//CodecCommandBuffer[0] = CODEC_MAP_PCMA_VOL;
	//CodecCommandBuffer[1] = 0x70;
	//send_codec_ctrl(CodecCommandBuffer, 3);

	//CodecCommandBuffer[0] = CODEC_MAP_PCMB_VOL;
	//CodecCommandBuffer[1] = 0x70;
	//send_codec_ctrl(CodecCommandBuffer, 3);

	CodecCommandBuffer[0] = CODEC_MAP_TONE_CTRL;
	CodecCommandBuffer[1] = 0x88;
	send_codec_ctrl(CodecCommandBuffer, 2);
